...
namespace CreateSodiumBindings
{
    public class SodiumBindingLibrary : ILibrary
    {
        ...
        public override void Setup(Driver driver)
        {
            ...
            var module = options.AddModule("Oprf.Net.Sodium");
            ...
            module.IncludeDirs.Add("/home/adam/repos/ChannelAdam/Oprf.Net/dependencies/sodium/libsodium-stable/src/libsodium/include/sodium");
