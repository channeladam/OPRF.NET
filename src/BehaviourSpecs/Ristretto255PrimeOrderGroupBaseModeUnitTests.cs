...
//-----------------------------------------------------------------------
// <copyright file="Ristretto255PrimeOrderGroupBaseModeUnitTests.cs"
...
namespace BehaviourSpecs
{
    ...
    {
        private CipherSuiteName _cipherSuiteName;
        ...
        public void WhenTheClientContextFinalisesTheEvaluatedGroupElement()
            => _actualBytes = _clientContext.Finalise(_testVectorInput, _testVectorBlindRandomScalar, _testVectorEvaluationElement);
