//-----------------------------------------------------------------------
// <copyright file="PrimeOrderGroupFactory.cs"
...
using Oprf.Net.PrimeOrderGroups;
...
namespace Oprf.Net
{
    public class PrimeOrderGroupFactory : IPrimeOrderGroupFactory
    {
        public IPrimeOrderGroup Create(CipherSuiteName cipherSuiteName, ICipherSuite cipherSuite)
            ...
            {
                CipherSuiteName.Ristretto255_SHA512 => new Ristretto255PrimeOrderGroup(cipherSuite),
