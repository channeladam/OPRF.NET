//
// Originally copied from https://github.com/mono/CppSharp/blob/main/src/Runtime/MarshalUtil.cs
//
...
namespace CppSharp.Runtime
{
    public static unsafe class MarshalUtil
    {
        ...
        public static IntPtr[]? GetIntPtrArray(IntPtr* array, int size) => GetArray<IntPtr>(array, size);

        public static T GetDelegate<T>(IntPtr[] vtables, short table, int i) where T : class
        {
            IntPtr slot = *(IntPtr*)(vtables[table] + (i * sizeof(IntPtr)));
